...
#  for the 7 Hotel World lessons.
#
#  Each lesson is an Array of steps.
#  Step types:
#    "dialogue"   → char, name, text
#    "sql_choice" → desc, options, correct_id, hint
#    "sql_fill"   → gamemode, desc, table, columns,
#                   table_headers, table_rows,
#                   answers, hint,
#                   result_headers, result_rows, result_msg
#    "end"        → (no extra fields)
#
#  Gamemode values map to GM_ scene files:
#    "select"       → GM_Select.tscn
#    "insert_into"  → GM_InsertInto.tscn
#    "select_where" → GM_SelectWhere.tscn
#    "update_set"   → GM_UpdateSet.tscn
#    "delete"       → GM_Delete.tscn
#    "order_by"     → GM_OrderBy.tscn
#    "group_by"     → GM_GroupBy.tscn
# ═══════════════════════════════════════════════════════
