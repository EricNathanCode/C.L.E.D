...
38: [
	...
	{ "type": "dialogue", "char": "mgr", "name": "MANAGER",
	  "npc": "NPC_occupations/hotel_manager/think",
	  "text": "The clerk just resigned. Now take that permission back what is the opposite of GRANT?" },
	{ "type": "sql_fill", "gamemode": "sql_blank", "recap": "GRANT / REVOKE",
	  "desc": "The clerk left. Remove their read access to the guests table. Fill in the DCL keyword.",
	  ...
	  "suffix": "SELECT ON guests FROM clerk;",
	  "err_hint": "To remove a permission, the keyword is REVOKE.",
	  "result_msg": "Permission revoked. The clerk can no longer read guests. GRANT gives access, REVOKE takes it back." },
	{ "type": "dialogue", "char": "mgr", "name": "MANAGER",
	  "npc": "NPC_occupations/hotel_manager/talk",
...
39: [
	...
	{ "type": "sql_fill", "gamemode": "sql_blank", "recap": "UNION / UNION ALL",
	  ...
	  "result_headers": ["city"], "result_rows": [["Manila"],["Cebu"],["Manila"],["Davao"]],
...
43: [
	...
	{ "type": "dialogue", "char": "mgr", "name": "MANAGER",
	  "npc": "NPC_occupations/hotel_manager/think",
	  "text": "Good. Now the email system needs the names in lowercase instead. Same idea, opposite function?" },
	{ "type": "sql_fill", "gamemode": "aggregate", "recap": "String Functions",
	  "desc": "Now show every guest name in lowercase. Fill in the string function.",
	  "hint": "LOWER() converts text to lowercase the opposite of UPPER().",
	  "table": "guests", "column": "name", "answer": "LOWER",
	  "table_headers": ["id", "name"],
	  "table_rows": [["1","ALICE"],["2","Bob"],["3","carol"]],
	  "result_headers": ["LOWER(name)"], "result_rows": [["alice"],["bob"],["carol"]],
	  "result_msg": "LOWER(name) returned every name in lowercase. UPPER capitalizes, LENGTH counts characters, SUBSTR extracts part of the text." },
	{ "type": "dialogue", "char": "mgr", "name": "MANAGER",
	  "npc": "NPC_occupations/hotel_manager/talk",
...
44: [
	...
	{ "type": "dialogue", "char": "mgr", "name": "MANAGER",
	  "npc": "NPC_occupations/hotel_manager/think",
	  "text": "Some of our older reports use IFNULL instead. Show me the same fix on the phone column with that two-argument version." },
	{ "type": "sql_fill", "gamemode": "sql_blank", "recap": "COALESCE / IFNULL",
	  "desc": "Replace a missing phone number with 'N/A' using the two-argument function. Fill in the function.",
	  ...
	  "suffix": "(phone, 'N/A') FROM guests;",
	  "err_hint": "The two-argument NULL replacement function is IFNULL.",
	  "table": "guests",
	  "table_headers": ["name", "phone"],
	  "table_rows": [["Alice","0917-555-1234"],["Bob","NULL"],["Carol","NULL"]],
	  "result_headers": ["name", "phone"],
	  "result_rows": [["Alice","0917-555-1234"],["Bob","N/A"],["Carol","N/A"]],
	  "result_msg": "IFNULL replaced the missing phone numbers with 'N/A'. COALESCE does the same and also accepts more than two values." },
	{ "type": "dialogue", "char": "mgr", "name": "MANAGER",
	  "npc": "NPC_occupations/hotel_manager/talk",
