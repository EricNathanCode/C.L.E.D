...
"L38": [
	...
	{ "type": "dialogue", "char": "librarian", "name": "LIBRARIAN",
	  "npc": "NPC_occupations/librarian/think",
	  "text": "The assistant just resigned. Now take that permission back what is the opposite of GRANT?" },
	{ "type": "sql_fill", "gamemode": "sql_blank", "recap": "GRANT / REVOKE",
	  "desc": "The assistant left. Remove their read access to the books table. Fill in the DCL keyword.",
	  ...
	  "suffix": "SELECT ON books FROM assistant;",
	  "err_hint": "To remove a permission, the keyword is REVOKE.",
	  "result_msg": "Permission revoked. The assistant can no longer read books. GRANT gives access, REVOKE takes it back." },
	{ "type": "dialogue", "char": "librarian", "name": "LIBRARIAN",
	  "npc": "NPC_occupations/librarian/talk",
...
"L39": [
	...
	{ "type": "sql_fill", "gamemode": "sql_blank", "recap": "UNION / UNION ALL",
	  ...
	  "result_headers": ["city"], "result_rows": [["Manila"],["Cebu"],["Manila"],["Iloilo"]],
...
"L43": [
	...
	{ "type": "dialogue", "char": "librarian", "name": "LIBRARIAN",
	  "npc": "NPC_occupations/librarian/think",
	  "text": "Good. Now the spine-label printer needs the titles in lowercase instead. Same idea, opposite function?" },
	{ "type": "sql_fill", "gamemode": "aggregate", "recap": "String Functions",
	  "desc": "Now show every book title in lowercase. Fill in the string function.",
	  "hint": "LOWER() converts text to lowercase the opposite of UPPER().",
	  "table": "books", "column": "title", "answer": "LOWER",
	  "table_headers": ["id", "title"],
	  "table_rows": [["1","DUNE"],["2","1984"],["3","neuromancer"]],
	  "result_headers": ["LOWER(title)"], "result_rows": [["dune"],["1984"],["neuromancer"]],
	  "result_msg": "LOWER(title) returned every title in lowercase. UPPER capitalizes, LENGTH counts characters, SUBSTR extracts part of the text." },
	{ "type": "dialogue", "char": "librarian", "name": "LIBRARIAN",
	  "npc": "NPC_occupations/librarian/talk",
...
"L44": [
	...
	{ "type": "dialogue", "char": "librarian", "name": "LIBRARIAN",
	  "npc": "NPC_occupations/librarian/think",
	  "text": "Some older catalog reports use IFNULL instead. Show me the same fix on the author column with that two-argument version." },
	{ "type": "sql_fill", "gamemode": "sql_blank", "recap": "COALESCE / IFNULL",
	  "desc": "Replace a missing author with 'Unknown' using the two-argument function. Fill in the function.",
	  ...
	  "suffix": "(author, 'Unknown') FROM books;",
	  "err_hint": "The two-argument NULL replacement function is IFNULL.",
	  "table": "books",
	  "table_headers": ["title", "author"],
	  "table_rows": [["Dune","Herbert"],["1984","NULL"],["Sula","NULL"]],
	  "result_headers": ["title", "author"],
	  "result_rows": [["Dune","Herbert"],["1984","Unknown"],["Sula","Unknown"]],
	  "result_msg": "IFNULL replaced the missing authors with 'Unknown'. COALESCE does the same and also accepts more than two values." },
	{ "type": "dialogue", "char": "librarian", "name": "LIBRARIAN",
	  "npc": "NPC_occupations/librarian/talk",
