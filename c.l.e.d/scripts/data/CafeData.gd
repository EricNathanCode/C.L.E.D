...
"C2": [
	...
	{ "type": "sql_fill",
	  ...
	  "hint": "Match each blank to what Carlos told you, in the same order as the INSERT statement's column list.",
...
"C3": [
	...
	{ "type": "sql_fill",
	  ...
	  "answer": "category",
	  "hint": "GROUP BY needs the column the report is broken down by — check what the owner wants counted per group.",
...
"C4": [
	...
	{ "type": "sql_fill",
	  ...
	  "answer": "Rivera",
	  "hint": "WHERE needs the exact name the customer just gave you.",
	  "result_headers": ["id", "customer_name", "drink", "food"],
...
"C5": [
	...
	{ "type": "sql_fill",
	  ...
	  "answer_id": "3",
	  "hint": "Use the corrected drink the customer just asked for, matched to the order id they gave you.",
	  "result_headers": ["id", "customer_name", "drink", "food"],
...
"C7": [
	...
	{ "type": "sql_fill",
	  ...
	  "answer": "ASC",
	  "hint": "Cheapest-first, lowest-to-highest, is the 'normal' sort direction — one of the two keywords means exactly that.",
...
"C17": [
	...
	{ "type": "sql_fill", "gamemode": "where_and_or",
	  ...
	  "table_headers": ["id","customer","item","price"],
	  "table_rows": [["1","Ana","Latte","4.50"],["2","Ben","Espresso","3.00"],["3","Cara","Latte","4.50"],["4","Dan","Cappuccino","4.00"],["5","Eve","Espresso","3.00"],["6","Fay","Latte","4.50"]],
	  "hint": "Ask yourself: does the owner need BOTH conditions true at once, or is just one enough? That decides the connector.",
...
"C19": [
	...
	{ "type": "sql_fill", "gamemode": "where_like",
	  ...
	  "hint": "LIKE's wildcard can go on both sides of a word to match it anywhere in the text, not just at the start.",
