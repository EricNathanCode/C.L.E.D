...
"P38": [
	...
	{ "type": "sql_fill", "gamemode": "sql_blank", "recap": "GRANT / REVOKE",
	  ...
	  "suffix": "SELECT ON cases FROM officer;",
	  "err_hint": "To remove a permission, the keyword is REVOKE.",
	  "result_msg": "Permission revoked. The officer can no longer read cases. GRANT gives access, REVOKE takes it back." },
	{ "type": "dialogue", "char": "chief", "name": "CHIEF",
	  "npc": "NPC_occupations/police/talk",
...
"P39": [
	...
	{ "type": "sql_fill", "gamemode": "sql_blank", "recap": "UNION / UNION ALL",
	  ...
	  "result_headers": ["city"], "result_rows": [["Manila"],["Quezon"],["Manila"],["Cebu"]],
...
"P43": [
	...
	{ "type": "sql_fill", "gamemode": "aggregate", "recap": "String Functions",
	  ...
	  "table_headers": ["id", "case_type"],
	  "table_rows": [["1","ROBBERY"],["2","Theft"],["3","assault"]],
	  "result_headers": ["LOWER(case_type)"], "result_rows": [["robbery"],["theft"],["assault"]],
	  "result_msg": "LOWER(case_type) returned every type in lowercase. UPPER capitalizes, LENGTH counts characters, SUBSTR extracts part of the text." },
	{ "type": "dialogue", "char": "chief", "name": "CHIEF",
	  "npc": "NPC_occupations/police/talk",
...
"P44": [
	...
	{ "type": "sql_fill", "gamemode": "sql_blank", "recap": "COALESCE / IFNULL",
	  ...
	  "table": "cases",
	  "table_headers": ["case_type", "location"],
	  "table_rows": [["Robbery","Main St"],["Theft","NULL"],["Assault","NULL"]],
	  "result_headers": ["case_type", "location"],
	  "result_rows": [["Robbery","Main St"],["Theft","Unknown"],["Assault","Unknown"]],
